...
import { normalizeExtractedTask } from '../src/lib/extractTaskFieldsNormalize.js'
...
export default async function handler(req, res) {
  ...
  try {
    ...
    body = {
      ...body,
      tasks_extracted_count: tasksExtractedCount,
      estimated_tasks_in_document: estimatedTasksInDoc,
      source_document_text: plain,
    }
