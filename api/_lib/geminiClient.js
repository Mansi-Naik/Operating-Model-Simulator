...
/** @typedef {'f1_extraction' | 'f1_re_extraction' | 'f2_allocation' | 'f3_role' | 'f3_emergent' | 'f4_variant_narrative' | 'f5_sensitivity' | 'f6_phase_narratives' | 'competitor_analysis' | 'reinvestment_opportunities'} GeminiFeature */
...
export const MODEL_CHAINS = {
  ...
  reinvestment_opportunities: ['gemini-2.5-flash-lite', 'gemini-2.5-flash', 'gemini-3-flash-preview'],
}
